...
open import Relation.Binary.PropositionalEquality.Core using (_≡_; refl; cong; sym; trans) public
open import Tactic.Cong using (cong!) public

pattern refl₍_₎ x = refl {x = x}

infix 4 PathAt
PathAt : ∀ (A : Set) (x y : A) → Set
PathAt A x y = _≡_ {A = A} x y
